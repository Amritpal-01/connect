...
const page = () => {
  return (
    <div className="h-[100dvh] mx-auto w-96 max-[800px]:w-full flex flex-col">
      ...
      <main className="flex-1 flex justify-center items-center">
        <div className="aspect-square h-44 rounded-full backdrop-blur-sm bg-white/10 border border-white/20"></div>
      </main>
